...
One with the closing had the lowest loss based on the model evaluation
* Determine which model tracks the actual values best over time. (8 points)
Closing model tracks the actual values best over time based on the plot
* Determine the appropriate Window Size for the model. (8 points)
looks like lower the window the better the actual vs predicted values and lower the loss. 
